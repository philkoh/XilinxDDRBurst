...
xst -ifn xst.scr
move PhilData2_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PhilData2_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PhilData2_exdes.ucf PhilData2_exdes

echo 'Running map'
map -timing PhilData2_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm PhilData2_exdes -w routed.ncd routed.vhd
cd ..
