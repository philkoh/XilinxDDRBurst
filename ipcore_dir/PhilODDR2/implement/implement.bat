...
xst -ifn xst.scr
move PhilODDR2_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PhilODDR2_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PhilODDR2_exdes.ucf PhilODDR2_exdes

echo 'Running map'
map -timing PhilODDR2_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm PhilODDR2_exdes -w routed.ncd routed.vhd
cd ..
