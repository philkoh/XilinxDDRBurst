...
xst -ifn xst.scr
move PhilPorts_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PhilPorts_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PhilPorts_exdes.ucf PhilPorts_exdes

echo 'Running map'
map -timing PhilPorts_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm PhilPorts_exdes -w routed.ncd routed.vhd
cd ..
