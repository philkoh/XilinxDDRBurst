...
xst -ifn xst.scr
move PhilODDR_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PhilODDR_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PhilODDR_exdes.ucf PhilODDR_exdes

echo 'Running map'
map -timing PhilODDR_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm PhilODDR_exdes -w routed.ncd routed.vhd
cd ..
