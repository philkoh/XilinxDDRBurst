...
xst -ifn xst.scr
move selectIoPhil_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\selectIoPhil_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc selectIoPhil_exdes.ucf selectIoPhil_exdes

echo 'Running map'
map -timing selectIoPhil_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm selectIoPhil_exdes -w routed.ncd routed.vhd
cd ..
