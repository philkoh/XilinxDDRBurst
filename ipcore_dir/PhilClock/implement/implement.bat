...
xst -ifn xst.scr
move PhilClock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PhilClock_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PhilClock_exdes.ucf PhilClock_exdes

echo 'Running map'
map -timing -pr b PhilClock_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm PhilClock_exdes -w routed.ncd routed.vhd
cd ..
