...
xst -ifn xst.scr
move DelayPorts_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\DelayPorts_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc DelayPorts_exdes.ucf DelayPorts_exdes

echo 'Running map'
map -timing DelayPorts_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm DelayPorts_exdes -w routed.ncd routed.vhd
cd ..
