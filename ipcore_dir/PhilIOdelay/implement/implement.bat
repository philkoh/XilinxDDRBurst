...
xst -ifn xst.scr
move PhilIOdelay_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PhilIOdelay_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PhilIOdelay_exdes.ucf PhilIOdelay_exdes

echo 'Running map'
map -timing PhilIOdelay_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm PhilIOdelay_exdes -w routed.ncd routed.vhd
cd ..
