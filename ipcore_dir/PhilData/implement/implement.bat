...
xst -ifn xst.scr
move PhilData_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PhilData_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PhilData_exdes.ucf PhilData_exdes

echo 'Running map'
map -timing PhilData_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm PhilData_exdes -w routed.ncd routed.vhd
cd ..
