...
xst -ifn xst.scr
move DelayedDataPort_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\DelayedDataPort_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc DelayedDataPort_exdes.ucf DelayedDataPort_exdes

echo 'Running map'
map -timing DelayedDataPort_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm DelayedDataPort_exdes -w routed.ncd routed.vhd
cd ..
